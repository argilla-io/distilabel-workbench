...
export WANDB_PROJECT="ultra-feedback-dutch-cleaned-hq-spin-geitje-7b-ultra-sft"
...
initial_model="BramVanroy/GEITje-7B-ultra-sft"
# Base model name for the different SPIN iterations, the models will be named as:
# - base_model_name{_iter{i}}
base_model_name="davidberenstein1957/ultra-feedback-dutch-cleaned-hq-spin-geitje-7b-ultra-sft"
...
# will be generated
initial_dataset="davidberenstein1957/ultra-feedback-dutch-cleaned-hq"
# Base model name for the different dataset SPIN iterations, the datasets will be named as:
# - base_dataset_name{_iter{i}}
base_dataset_name="davidberenstein1957/ultra-feedback-dutch-cleaned-hq"
...
real_dataset="davidberenstein1957/ultra-feedback-dutch-cleaned-hq-with-responses"
# The base name for the WANDB experiments, under WANDB_PROJECT
wandb_name_base="spin-zephyr-geitje"
...
for ((i = 0; i < ${#config_files[@]}; i++)); do
    ...
    command_train="accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=4 spin/run_spin.py ${config_files[i]}"
